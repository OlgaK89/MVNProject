...
public class RecipeTest extends TestBase {
    ...
    public void positiveRecipeConvert() {
       ...
       // logger = report.createTest("positiveRecipeConvert"); //creating the object
        ...
        logger.info("Insert recipe name"); //marking the steps
        rp.recipeName.sendKeys("Cake");
        SeleniumUtils.waitFor(2);

        logger.info("Insert recipe notes");
        ...
        //logger.pass("Selected"); //marking the result
    }
